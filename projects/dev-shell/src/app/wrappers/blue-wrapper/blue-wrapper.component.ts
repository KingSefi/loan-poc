...
import { BlueProjectStep } from './blue-project-step';
...
const TOPNAV_MENUS: readonly MenuGroup[] = [
  ...
  { icon: 'support_agent', label: 'Contact' },
];
  ...
  providers: [
    ...
    },
    {
      ...
      useValue: {
        ...
        infoText: 'L\'assurance emprunteur protège vous et votre famille en cas d\'imprévu.',
      },
    },
    {
...
export class BlueWrapper implements OnInit {
  private readonly themeService = inject(ThemeService);

  ngOnInit(): void {
    this.themeService.theme.set('light');
    this.themeService.brandClass.set('blue-brand');
  }
}
